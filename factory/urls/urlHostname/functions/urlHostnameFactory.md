...
[collectype](../../../../modules.md) / [factory/urls/urlHostname](../README.md) / urlHostnameFactory

# Function: urlHostnameFactory()

> **urlHostnameFactory**\<`T`, `C`\>(`ctx`, `oper`): \<`K`\>(`field`, `target`) => `C`

Defined in: [factory/urls/urlHostname.ts:34](https://github.com/maduhaime/collectype/blob/3e0753826a271651d85809f1ed54de03737b5ef6/src/factory/urls/urlHostname.ts#L34)
...
The URL hostname operation to perform.
