...
[collectype](../../../../modules.md) / [factory/urls/urlHost](../README.md) / urlHostFactory

# Function: urlHostFactory()

> **urlHostFactory**\<`T`, `C`\>(`ctx`, `oper`): \<`K`\>(`field`, `target`) => `C`

Defined in: [factory/urls/urlHost.ts:34](https://github.com/maduhaime/collectype/blob/3e0753826a271651d85809f1ed54de03737b5ef6/src/factory/urls/urlHost.ts#L34)
...
The URL host operation to perform.
